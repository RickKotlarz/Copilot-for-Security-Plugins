...
5. [Increase effeciency](#increasing-effeciency)
...
```
![Prompt with no markdown](./images/001_prompt_no_markdown.png)
...
```
![AskGPT prompt outlining the markdown requirements (formatted as a table)](./images/002_AskGPT_markdown_formatting.png)
...
![Results of the initial prompt (formatted as a table) that includes output formatted using markdown from the previous instructions](./images/003_AskGPT_formatting_as_a_table_prompt.png)
...
![AskGPT prompt outlining the markdown requirements (formatted as bullets)](./images/004_AskGPT_formatting_as_a_list_prompt.png)


![Results of the initial prompt (formated in bullets) that includes output formatted using markdown from the previous instructions](./images/005_AskGPT_formatting_as_a_list_result.png)
...
```
![Combined prompt that includes the request for 3 incidents from Defender along with markdown formatting that denotes output should be in a table](./images/006_prompt_that_includes_AskGPT_formatting.png)
